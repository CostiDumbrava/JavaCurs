...
public class BonusuriV2 {
	...
	public static void main(String[] args) {
		...
		if (vanzari <= VAL_VANZARI1)  {
			System.out.println("Felicitari, primiti bonus: " +BONUS3);
			flag = false;
			break;
		} else if ((vanzari > VAL_VANZARI1) && (vanzari <=VAL_VANZARI2))  {
			...
			do {
		      ...
		      }else {System.out.println("Felicitari, primiti bonus: " +BONUS7);
		      flag = false;
			  break;}
		
		while (vanzari > VAL_VANZARI1) {
		
		 if  (luna <= 6) {
			System.out.println("Felicitari, primiti bonus: " +BONUS4);	
			flag = false;
			break;
			} else if (luna == 12){
			System.out.println ("Primiti bonus: " +BONUS6 +"." +" In decembrie se vand singure! ");
			flag = false;
			break;

	   } else {
		System.out.println("Felicitari, primiti bonus: " +BONUS5);	
		flag = false;
		break;
	}
	}
